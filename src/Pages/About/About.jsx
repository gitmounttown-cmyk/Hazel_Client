      ...
      >
        <div className="hero-content">
          ...
          <p className="hero-copy hero-copy-light">
            We believe that clothing should never feel like a compromise.
            Explore our journey to craft everyday nightwear dedicated to comfort
      ...
      <section className="intro">
        <div className="intro-text">
          <h2 className="section-title">
            Because comfort should never mean compromising on how you feel.
          </h2>
          <p className="body-copy">
            In a world that demands so much of our energy, your home and your
            rest should be sacred. We started with a simple realization: the
            transition from the world to the home was lacking a uniform that
            felt both elevated and effortless.
          </p>
          <p className="body-copy">
            Every seam, every fabric choice, and every silhouette is designed
            with the human body in mind—honoring its movements, its needs, and
            its desire for softness.
          </p>
        </div>
        ...
        <div className="intro-images-wrapper">
          ...
          />
          <img src={Main} alt="Fabric texture" className="intro-main-img" />
        </div>
      </section>
        ...
        <div className="timeline">
          <div className="timeline-row timeline-row-reverse">
            <div
              ...
              style={{
                backgroundImage: `url(${TimelineImg1})`,
            ...
            <div className="timeline-text">
              ...
              <div className="timeline-content-group">
                ...
                <p className="body-copy">
                  ...
                  one that didn't feel like a costume or an afterthought. We
                  wanted something that felt like a<br />
          ...
          <div className="timeline-row">
            <div
              className="timeline-image"
              style={{
                backgroundImage: `url(${TimelineImg2})`,
                backgroundSize: "cover",
                backgroundPosition: "center",
                borderRadius: "8px",
              }}
            ...
            <div className="timeline-text">
              ...
              <div className="timeline-content-group">
                ...
                <p className="body-copy">
                  ...
                  the way it breathed. Our first six silhouettes were born from
                  this obsession.
                </p>
              </div>
            </div>
        ...
        <div className="timeline-text-grid">
          <div className="timeline-text-only">
            ...
            <div className="timeline-content-group">
              ...
              <p className="body-copy">
                Our growth wasn't driven by trends, but by
                <br />
                feedback. We heard from new mothers, busy
                <br />
                professionals, and creative spirits who all sought
                <br />
                the same thing: a garment that respected their
                <br />
                time and comfort.
              </p>
            </div>
          ...
          <div className="timeline-text-only">
            ...
            <div className="timeline-content-group">
              ...
              <p className="body-copy">
                Today, Lumière is more than a brand; it's a community. We
                continue to
                <br />
                design with the same founding principles: premium quality,
                ethical <br />
        ...
        <div className="manifesto-grid">
          <div className="manifesto-card1">
            ...
            <p className="manifesto-copy">
              If it doesn't feel effortless, it doesn't make the cut. We
              prioritize tactile experience above all else.
            </p>
            <div
              className="manifesto-image1"
              style={{
                backgroundImage: `url(${ManifestoImg1})`,
                backgroundSize: "cover",
                backgroundPosition: "center",
                borderRadius: "8px",
              }}
          ...
          <div className="manifesto-card2">
            ...
            <p className="manifesto-copy">
              Longevity is the ultimate sustainability. Our pieces are designed
              to be loved and lived in for years.
            </p>
            <div
              className="manifesto-image2"
              style={{
                backgroundImage: `url(${ManifestoImg2})`,
                backgroundSize: "cover",
                backgroundPosition: "center",
                borderRadius: "8px",
              }}
          ...
          <div className="manifesto-card3">
            ...
            <p className="manifesto-copy">
              From pockets in nightdresses to feeding-friendly closures, we
              solve the small frustrations of daily life.
            </p>
            <div
              className="manifesto-image3"
              style={{
                backgroundImage: `url(${ManifestoImg3})`,
                backgroundSize: "cover",
                backgroundPosition: "center",
                borderRadius: "8px",
              }}
      ...
      <section className="customers">
        ...
        <div className="collage">
          <div className="collage-col">
            ...
            ></div>
            <div
              className="collage-tall2"
              style={{
                backgroundImage: `url(${CustomerImg2})`,
                backgroundSize: "cover",
                backgroundPosition: "center",
                borderRadius: "8px",
              }}
          ...
          <div
            ...
            style={{
              backgroundImage: `url(${CustomerGroup})`,
              backgroundSize: "cover",
              backgroundPosition: "center",
              borderRadius: "8px",
            }}
          ...
          <div className="collage-col">
            <div
              className="collage-tall3"
              style={{
                backgroundImage: `url(${CustomerImg3})`,
                backgroundSize: "cover",
                backgroundPosition: "center",
                borderRadius: "8px",
              }}
